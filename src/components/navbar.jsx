            ...
            <div className="md:hidden w-full h-[6vh] bg-gray-900 text-white shadow-md shadow-gray-500 fixed">
                ...
                {openNav && (
                    <div className="w-full bg-gray-700 p-5">
                        ...
                        <ul className="py-5 gap-6 flex flex-col group font-semibold">
                            <li className="group-hover:text-gray-400">
                                <Link onClick={() => setOpenNav(!openNav)}  className="flex gap-2 items-center hover:text-white transition-all duration-500 ease-in-out" to={'/countdown'}><PiClockCountdownFill className="text-2xl hidden lg:block" />Countdown</Link>
                            </li>
                            <li className="group-hover:text-gray-400">
                                <Link onClick={() => setOpenNav(!openNav)} className="flex gap-2 items-center hover:text-white transition-all duration-500 ease-in-out" to={'/convert'}><BsCurrencyExchange className="text-2xl hidden lg:block" />Currency Convert</Link>
                            </li>
                            <li className="group-hover:text-gray-400">
                                <Link onClick={() => setOpenNav(!openNav)} className="flex gap-2 items-center hover:text-white transition-all duration-500 ease-in-out" to={'/list-ml'}><PiGameControllerFill className="text-2xl hidden lg:block" />Mobile Legends</Link>
                            </li>
                            <li className="group-hover:text-gray-400">
                                <Link onClick={() => setOpenNav(!openNav)} className="flex gap-2 items-center hover:text-white transition-all duration-500 ease-in-out" to={'/tictactoe'}><GiTicTacToe className="text-2xl hidden lg:block" />Tic Tac Toe</Link>
                            </li>
                            <li className="group-hover:text-gray-400">
                                <Link onClick={() => setOpenNav(!openNav)} className="flex gap-2 items-center hover:text-white transition-all duration-500 ease-in-out" to={'/matching-card'}><GiCardRandom className="text-2xl hidden lg:block" />Matching Card</Link>
                            </li>
                            <li className="group-hover:text-gray-400">
                                <Link onClick={() => setOpenNav(!openNav)} className="flex gap-2 items-center hover:text-white transition-all duration-500 ease-in-out" to={'/salary-calc'}><ImCalculator className="text-2xl hidden lg:block" />Salary Calculating</Link>
                            </li>
                            <li className="group-hover:text-gray-400">
                                <Link onClick={() => setOpenNav(!openNav)} className="flex gap-2 items-center hover:text-white transition-all duration-500 ease-in-out" to={'/word-scramb'}><BsFileWordFill className="text-2xl hidden lg:block" />Word Scramb</Link>
                            </li>
                        </ul>
                    </div>
                )}
