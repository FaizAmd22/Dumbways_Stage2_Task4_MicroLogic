            ...
            <div className='w-[90%] flex flex-col gap-5'>
                ...
                <div className='flex flex-col justify-center items-center gap-5'>
                    ...
                    <label className='w-[50%] flex flex-col items-center'>
                        <input type="text" value={userInput} placeholder="Input your guess" onChange={handleInputChange} className='w-full shadow-md shadow-gray-300 rounded-xl pl-5 py-1' />
                    </label>
